...
import { ApplicationStatus, GrantInteractionType, LikedStatus } from '@common/graphql-typings.generated';
...
export class GrantService {
     ...
     */
    async interactWithGrant(grantId: number, userId: number, interactionType: GrantInteractionType, feedbackText?: string): Promise<GrantUserInteraction> {
